...
//       buf[i] = ' ';
//     else
//       buf[i] = ps->text[ps->index - 6 + i];
//   }
//   buf[6] = '|';
//   buf[7] = ps->text[ps->index];
//   buf[8] = '|';
//   bool eof = ps->text[ps->index] == '\0';
//   for (int i = 0; i < 6; ++i)
//   {
//     if (eof)
//       buf[9 + i] = ' ';
//     else
//     {
//       eof = ps->text[ps->index + 1 + i] == '\0';
//       buf[9 + i] = ps->text[ps->index + 1 + i];
//     }
//   }
//   buf[15] = '\0';
...
// int peek_part(parsing_state *ps, char **out_seg, int parts_ahead)
// {
//   int o = ps->index;
//   while (mctrue)
//   {
//     char first_char = ps->text[o];

//     bool isEmpty = mcfalse;
//     bool isAlpha = mcfalse;
//     switch (first_char)
//     {
//     case '\0':
//     {
//       *out_seg = (char *)malloc(sizeof(char) * 1);
//       out_seg[0] = '\0';
//       return 0;
//     }
//     case ' ':
...
// int peek_token(parsing_state *ps, token_type *ptk)
// {
...
//       if (isalpha(ps->text[ps->index]))
//       {
//         *ptk = TOKEN_IDENTIFIER;
//         return 0;
//         // char *id;
//         // peek_identifier(ps, &id);
...
//         // default:
//         // {
//         //   print_parse_error(ps, "peek_token", "CODE_BLOCK>def:isalpha");
//         //   return -12;
//         // }
//         // }
//       }
...
//   {
//     char *part;
//     PRCE(peek_part(ps, &part, 0))

//     return -8;
//     printf("parse_code_block>code_block_switch#unhandled-token:%i\n", " ");
//   }
