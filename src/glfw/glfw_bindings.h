...
public:
    static void *runTriangle(void **args, int argCount)
    {
        ...
        int screenWidth = screenHeight * 1.6; // 1080
        std::string windowName = "midge";
        GLFWwindow **window;
        int *result = new int();
        ...
        *window = glfwCreateWindow(screenWidth, screenHeight, title, NULL, NULL);
        ...
        // ------------------------------------
        Shader ourShader("./src/glfw/shaders/3.3.shader.vs", "./src/glfw/shaders/3.3.shader.fs");
